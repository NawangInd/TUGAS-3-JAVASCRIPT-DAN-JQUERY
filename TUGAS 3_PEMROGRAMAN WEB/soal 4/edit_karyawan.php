<?php
    include "koneksi.php";
    $id = $_GET['idkaryawan'];
    $ambilData = mysqli_query($koneksi, "SELECT * FROM karyawan WHERE idkaryawan='$id'");
...
<?php
        if(isset($_POST['simpan']))
        {
            ...
            mysqli_query($koneksi, "UPDATE karyawan 
            SET nama='$nama', telp='$telp', alamat='$alamat', kota='$kota', kodepos='$kodepos'
            WHERE idkaryawan='$id'") or die(mysqli_error($koneksi));
